 ...
 *******************************************************************************/
package org.openhealthtools.mdht.cda.hitsp.example;
...
public class TestPatientSummary {
	...
	public static void main(String[] args) throws Exception {
		...
		ClinicalDocument minimalSample = CDAUtil.load(new FileInputStream(
			"samples/CCD_HITSP_C32v2.5_Minimal_WithEntries_Valid.xml"));
	...
	public static PatientSummary createPatientSummary() {
		...
		II id = DatatypesFactory.eINSTANCE.createII(
			"2.16.840.1.113883.3.72", "CCD_HITSP_C32v2.4_16SectionsWithEntries_Rev6_Notes");
