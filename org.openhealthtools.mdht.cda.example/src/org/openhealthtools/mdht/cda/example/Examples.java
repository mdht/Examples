...
public class Examples {
	...
	public static void createClinicalDocumentExample() throws Exception{
		
		
		/*
		 * EMF uses the factory pattern to support object creation
		 */
	...
	public static void readClinicalDocumentExample() throws Exception
	{
	...
	public static void readAndValidateClinicalDocumentExample() throws Exception
	{
	...
	public static void main(String[] args) throws Exception {
		...
		createClinicalDocumentExample();
		
		readClinicalDocumentExample();
		
		readAndValidateClinicalDocumentExample();
	}
